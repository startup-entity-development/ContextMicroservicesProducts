...
class GeneralException(Exception):
    ...
    def __init__(self,
        ...
        self.message:str = f"message: {message},code_exeption:{self.code} extra_data: {data_dict}"
...
class ProductMutationException(GeneralException):
    pass


class ProductExternalResourceException(GeneralException):
    pass
