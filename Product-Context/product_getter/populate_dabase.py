...
from data_source_integrations.product_redcircle import ProductRedCircle
...
class PopulateDatabase():
    ...
    def create_collection_file_subcategories(self) -> None:
        self.subcategory_red_circle.create_categories_cvs_file_buch_request()
    
    def create_collection_file_products(self) -> None:
        self.product_red_circle.create_products_cvs_file_buch_request()
        

    def get_initial_pagination(self) -> None:
        self.product_red_circle.create_initial_pagination(list_product_search_result=self.product_red_circle.list_product_search_result)
    
    
    def load_products_collection(self) -> None:
        self.product_red_circle.load_product_from_json_file()
    
    def update_product_descrition_and_barcode(self) -> None:
        self.product_red_circle.update_product_datails_from_file_json()
...
if __name__ == "__main__":
    ...
    populate_database.update_product_descrition_and_barcode()
