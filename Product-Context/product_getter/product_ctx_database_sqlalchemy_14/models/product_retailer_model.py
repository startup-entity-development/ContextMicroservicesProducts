...
class ModelProductRetailer(Base):
    ...
    retailer = relationship(
        ModelRetailer,  backref="Product_Retailer",overlaps="Product_Retailer,retailer", viewonly=True, lazy='joined')
    
    product = relationship(
        "ModelProduct",  backref="Product_Retailer",overlaps="Product_Retailer,product", viewonly=True,  lazy='joined')
