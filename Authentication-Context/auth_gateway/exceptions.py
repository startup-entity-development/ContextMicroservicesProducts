...
class GeneralException(Exception):
    ...
    def __init__(self,
        ...
        self.message:str = f"message: {message}, extra_data: {data_dict}"
...
class AccountManagementException(GeneralException):
    pass


class AuthorizationManagementException(GeneralException):
    pass
